-- Enable TimescaleDB extension (production only)
...
-- Vital Readings (TimescaleDB hypertable in production)
...
CREATE INDEX idx_alerts_unacked ON alerts (user_id, acknowledged) WHERE acknowledged = FALSE;
